      ...
      <main className="flex-1 p-3 lg:p-4 space-y-3 lg:space-y-4 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-3 lg:gap-4">
          ...
          <div className="xl:col-span-2">
            <Card className="premium-card rounded-3xl overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white shadow-2xl border-0 h-full min-h-[180px] lg:min-h-[200px] relative">
              ...
              <div className="p-4 lg:p-5 relative z-10 h-full flex flex-col bg-blue-600">
                <div className="flex items-center justify-between h-full">
                    ...
                    {latestUpcomingClass ? (
                      ...
                      <>
                        <div className="flex items-center space-x-3 mb-3">
                          ...
                          <div>
                            <div className="mb-1">
                              <span className="inline-block bg-yellow-100 text-yellow-800 text-xs font-bold px-2 py-0.5 rounded-full mr-2">Past Class</span>
                            </div>
                      ...
                      <>
                        <div className="flex items-center space-x-3 mb-3">
                          ...
                          <div>
                            <h2 className="text-xl lg:text-2xl font-bold text-white drop-shadow-lg tracking-tight">No Upcoming Classes</h2>
                            <p className="text-sm lg:text-base text-white/90 font-medium">Check your completed classes and homework</p>
                          </div>
                        </div>
                  ...
                  <div className="bg-white/10 backdrop-blur-2xl p-3 lg:p-4 rounded-3xl border border-white/20 ml-3 shadow-2xl hidden sm:block">
        ...
        <Card className="premium-card p-4 lg:p-5 rounded-3xl glass-card bg-gradient-to-br from-white/95 to-slate-50/95 border-2 border-slate-200/50 shadow-2xl backdrop-blur-xl">
